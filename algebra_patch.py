"""
Exact, deterministic algebraic-geometry routines translated from ``代数补丁.sage``.

Key features:
- Garcia–Stichtenoth tower W1 construction and one-point AG code helpers.
- Drinfeld modular subtower W3 construction with explicit genus bookkeeping.
- Norm–Trace curve evaluation and trace-code construction.

The implementation avoids heuristics and floating approximations; all
certificates rely on exact valuations, residue evaluations, and linear algebra
over finite fields.
"""
